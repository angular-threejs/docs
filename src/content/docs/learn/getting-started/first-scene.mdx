...
`NgtCanvasContent` directive acts as an anchor so `NgtCanvas` can render the content when the store is ready. You can use either the micro-syntax (`*canvasContent`) or long syntax (`<ng-template canvasContent>`).
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={1} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={2} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={3} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={4} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={5} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={6} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={7} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={8} />
</DemoWrapper>
...
<DemoWrapper>
	<FirstScene client:only="@analogjs/astro-angular" step={9} />
</DemoWrapper>
