...
import AllPeerDeps from '@ui/all-peer-deps.astro';

The following table shows all peer dependencies across Angular Three packages. Install only what you need based on which packages you're using.
