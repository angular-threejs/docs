...
import LODDemo from '../../../../../components/scenes/lod-demo/lod-demo';
...
<div class="h-[600px] w-full rounded border border-dashed border-accent-600 dark:border-accent-200">
 <LODDemo client:only />
 <a class="font-mono text-sm" href="https://codesandbox.io/s/12nmp">
  Credits: R3F Bust LOD
 </a>
</div>
...
export class Model {
    protected gltfs = injectGLTF(() => [lowGLB, midGLB, highGLB]);
}
```
