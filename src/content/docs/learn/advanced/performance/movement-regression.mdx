...
import MovementRegressionDemo from '../../../../../components/scenes/movement-regression-demo/movement-regression-demo';
...
<div class="h-[600px] w-full rounded border border-dashed border-accent-600 dark:border-accent-200">
 ...
 <a
  ...
  href="https://codesandbox.io/p/sandbox/pz0q6?file=/src/App.js:1,1-115,1"
  target="_blank"
  noreferer
 >
