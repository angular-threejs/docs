...
import InstanceScatterDemo from '@scenes/instance-scatter-demo/instance-scatter-demo';
...
import { extend, beforeRender, NgtArgs } from 'angular-three';
...
<div class="h-[600px] w-full rounded border border-dashed border-accent-600 dark:border-accent-200">
	<InstanceScatterDemo client:only="@analogjs/astro-angular" />
</div>
<Credit link="https://threejs.org/examples/#webgl_instancing_scatter">Credits: THREE.js Instancing Scatter</Credit>

Setting up instancing can be confusing if you're new to THREE.js. Consult [THREE.js docs](https://threejs.org/docs/#api/en/objects/InstancedMesh) if you need help.
