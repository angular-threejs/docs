...
You might have already seen this directive in action on the home page. Let's build it here together. The key is [`injectObjectEvents`](/reference/core/object-events) function from `angular-three`.
