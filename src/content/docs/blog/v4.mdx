...
v4 introduces `angular-three-theatre` for complex, timeline-based animations with a visual editor. You can see it in action in the [Basic Theatre demo](https://angularthree-demo-next.netlify.app/theatre/basic).
