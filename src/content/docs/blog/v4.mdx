...
Here's a real example from our demos showing how to create routed 3D scenes with shared layout elements. You can see it live at [https://demo.angularthree.org/routed](https://demo.angularthree.org/routed).
...
For common use cases, Soba provides specialized resource functions. Here's a real example from the [Basic Soba demo](https://demo.angularthree.org/soba/basic) showing how to load a GLTF model with matcap textures:
...
v4 introduces `angular-three-theatre` for complex, timeline-based animations with a visual editor. You can see it in action in the [Basic Theatre demo](https://demo.angularthree.org/theatre/basic).
...
v4 adds `angular-three-tweakpane` for debug UI controls. You can see it in action in the [Epoxy Resin demo](https://demo.angularthree.org/soba/epoxy-resin) and the [Basic Soba demo](https://demo.angularthree.org/soba/basic).
...
| ------------------------------------------------------------------------ | ------------ | ---------------------------------------- |
| [`PointerLockControls`](/reference/soba/controls/pointer-lock-controls/) | controls     | First-person pointer lock                |
| [`TrackballControls`](/reference/soba/controls/trackball-controls/)      | controls     | Trackball camera controls                |
| [`BVH`](/reference/soba/performances/bvh/)                               | performances | Bounding volume hierarchy for raycasting |
| [`Cloud`](/reference/soba/staging/cloud/)                                | staging      | Volumetric clouds                        |
| [`Shadow`](/reference/soba/staging/shadow/)                              | staging      | Shadow plane                             |
| [`Sparkles`](/reference/soba/staging/sparkles/)                          | staging      | Particle sparkle effect                  |
...
| Demo                                                                                  | Description                              |
| ------------------------------------------------------------------------------------- | ---------------------------------------- |
| [Stars](https://demo.angularthree.org/soba/stars)                                     | Starfield with camera controls           |
| [Epoxy Resin](https://demo.angularthree.org/soba/epoxy-resin)                         | MeshTransmissionMaterial with Tweakpane  |
| [Portal Shapes](https://demo.angularthree.org/soba/portal-shapes)                     | Portal rendering with MeshPortalMaterial |
| [Aquarium](https://demo.angularthree.org/soba/aquarium)                               | Underwater scene with caustics           |
| [Camera Scroll](https://demo.angularthree.org/soba/camera-scroll)                     | Scroll-driven camera animation           |
| [Routed Scenes](https://demo.angularthree.org/routed)                                 | Angular routing with 3D scenes           |
| [Instances](https://demo.angularthree.org/soba/instances)                             | Instanced rendering for performance      |
| [Inverted Stencil Buffer](https://demo.angularthree.org/soba/inverted-stencil-buffer) | Stencil buffer techniques                |
