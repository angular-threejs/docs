...
import HudScene, {
	content as hudContent,
	sceneGraphContent as hudSceneGraphContent,
} from '@scenes/hud-demo/hud-demo?includeContent';
import LightformerDemo, {
	content as lightformerContent,
	sceneGraphContent as lightformerSceneGraphContent,
} from '@scenes/lightformer-demo/lightformer-demo?includeContent';
...
<Tabs>
	<TabItem label="Preview">
		<div class="border-accent-500 h-96 w-full rounded border border-dashed">
			<HudScene client:only="@analogjs/astro-angular" />
		</div>
	</TabItem>
	...
	<TabItem label="scene-graph.ts">
		<Code code={hudSceneGraphContent} lang="angular-ts" />
	</TabItem>
</Tabs>
...
<Tabs>
	<TabItem label="Preview">
		<div class="border-accent-500 h-96 w-full rounded border border-dashed">
			<LightformerDemo client:only="@analogjs/astro-angular" />
		</div>
	</TabItem>
	<TabItem label="canvas.ts">
	...
	<TabItem label="scene-graph.ts">
		<Code code={lightformerSceneGraphContent} lang="angular-ts" />
	</TabItem>
</Tabs>
