...
import ToneMapping, { content, sceneGraphContent } from '@postprocessing/tone-mapping/tone-mapping?includeContent';

<Tabs>
	<TabItem label="Preview">
		<DemoWrapper>
			<ToneMapping client:only="@analogjs/astro-angular" />
		</DemoWrapper>
	</TabItem>
